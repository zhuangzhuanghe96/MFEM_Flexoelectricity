...
%
% This code generates the results (Fig.8) discussed in Section 4.4.
% 
...
% --- [网格输入] ---
conf.filename = 'mesh_bandgap.mphtxt';
...
BC_List = {}; 
BC_List{end+1} = struct('tag', [5 6], 'type', 'phi', 'value', [0,0]);
...
% save("MFEM_bandgap.txt", "data", '-ascii');
