...
%
% This code generates the results discussed in Section 4.3.
% 
...
plot_boundary_result(mesh, results, 3, 'psi11', 'arc', "r-", "markerSize", 15, 'LineWidth', 1.5);
plot_boundary_result(mesh, results, 3, 'psi22', 'arc', "r-", "markerSize", 15, 'LineWidth', 1.5);
